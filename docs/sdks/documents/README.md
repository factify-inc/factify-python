...
<!-- UsageSnippet language="python" operationID="createDocument" method="post" path="/v1beta/documents" -->
```python
from factify import Factify
...
<!-- UsageSnippet language="python" operationID="updateDocument" method="patch" path="/v1beta/documents/{document_id}" -->
```python
from factify import Factify
