...
<!-- UsageSnippet language="python" operationID="createApiKey" method="post" path="/v1beta/api-keys" -->
```python
from factify import Factify
...
<!-- UsageSnippet language="python" operationID="revokeApiKey" method="post" path="/v1beta/api-keys/{api_key_id}/revoke" -->
```python
from factify import Factify
