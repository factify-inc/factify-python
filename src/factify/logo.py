...
class Logo(BaseSDK):
    def upload(
        ...
        *,
    ...
    ) -> models.UploadOrganizationLogoResponseResponse:
        ...
        :param content_type: Informational content type. The server detects format from magic bytes.
        :param image_data: Raw image bytes. Maximum 2 MB. Accepted formats: JPEG, PNG, WebP, SVG.
        ...
        request = models.UploadOrganizationLogoRequest(
            ...
            body=models.UploadOrganizationLogoUploadOrganizationLogoRequest(
        ...
        req = self._build_request(
            method="POST",
            path="/v1beta/organizations/{organization_id}/logo",
            base_url=base_url,
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                ...
                False,
                "json",
                models.UploadOrganizationLogoUploadOrganizationLogoRequest,
            ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.UploadOrganizationLogoResponseResponse(
