...
from factify import errors, utils
from factify._hooks import (
    AfterErrorContext,
    AfterSuccessContext,
    BeforeRequestContext,
    HookContext,
)
from factify.utils import (
    RetryConfig,
    ...
    def do_request(
        ...
        if is_error_status_code(http_res.status_code):
            ...
            if result is not None:
                ...
                raise errors.FactifyDefaultError("Unexpected error occurred", http_res)
        else:
