...
class Versions(BaseSDK):
    ...
    def list(
        ...
        *,
    ...
    ) -> Optional[models.ListDocumentVersionsResponse]:
        ...
        def next_func() -> Optional[models.ListDocumentVersionsResponse]:
    ...
    async def list_async(
        ...
        *,
        ...
        def next_func() -> Awaitable[Optional[models.ListDocumentVersionsResponse]]:
            body = utils.unmarshal_json(http_res.text, Union[Dict[Any, Any], List[Any]])
    ...
    def create(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.CreateDocumentVersionResponse:
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.body, False, False, "multipart", models.CreateVersionRequest
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
    ...
    def get_record(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.GetVersionRecordResponse:
        r"""Retrieve a record
        ...
        :param version_id: Version ID to retrieve the record for.
            Pattern: ver_[0-9a-hjkmnp-tv-z]{26}
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        ...
        request = models.GetVersionRecordRequest(
            version_id=version_id,
        )
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return models.GetVersionRecordResponse(
                result=unmarshal_json_response(models.GetRecordResponse, http_res),
                headers={},
            )
        if utils.match_response(
            http_res, ["400", "401", "403", "404"], "application/json"
