...
from factify.preferences import Preferences
    ...
    def get_me(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.GetMeResponseResponse(
                result=unmarshal_json_response(models.GetMeResponse, http_res),
                headers={},
            )
