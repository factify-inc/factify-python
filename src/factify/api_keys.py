        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ListAPIKeysResponseResponse(
                list_api_keys_response=unmarshal_json_response(
                    Optional[models.ListAPIKeysResponse], http_res
                ),
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.CreateAPIKeyResponseResponse(
                create_api_key_response=unmarshal_json_response(
                    Optional[models.CreateAPIKeyResponse], http_res
                ),
                http_meta=models.HTTPMetadata(request=req, response=http_res),
                headers={},
            )
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.RevokeAPIKeyResponseResponse(
                revoke_api_key_response=unmarshal_json_response(
                    Optional[models.RevokeAPIKeyResponse], http_res
                ),
                http_meta=models.HTTPMetadata(request=req, response=http_res),
                headers={},
            )
