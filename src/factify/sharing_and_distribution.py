...
class SharingAndDistribution(BaseSDK):
    r"""Generate shareable entry pages for documents."""

    def generate_document_entry_page(
        self,
        *,
        document_id: str,
    ...
    ) -> models.FactifyAPIV1betaGenerateEntryPageResponse:
        r"""Generate entry page
        ...
        request = models.GenerateDocumentEntryPageRequest(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="generateDocumentEntryPage",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.FactifyAPIV1betaGenerateEntryPageResponse, http_res
            )
    ...
    async def generate_document_entry_page_async(
        self,
        *,
        document_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
