...
class Invites(BaseSDK):
    ...
    def create(
        ...
        *,
        ...
        :param idempotency_key: Optional client-provided idempotency key for safe retries.
    ...
    def accept(
        ...
        *,
        ...
        :param organization_id: Organization the invitation belongs to.
            Pattern: org_[0-9a-hjkmnp-tv-z]{26}
        :param invite_id: Invitation ID to accept.
        ...
        req = self._build_request(
            method="POST",
            path="/v1beta/organizations/{organization_id}/invites/{invite_id}:accept",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=True,
