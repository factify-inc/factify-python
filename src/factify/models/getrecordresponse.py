...
class GetRecordResponseTypedDict(TypedDict):
    r"""GetRecordResponse contains the processed document content and layout."""

    document: NotRequired[QcrV1alphaDocumentRecordTypedDict]
    ...
    r"""Source format of the original upload (e.g., pdf, docx, xlsx)."""


class GetRecordResponse(BaseModel):
    r"""GetRecordResponse contains the processed document content and layout."""

    document: Optional[QcrV1alphaDocumentRecord] = None
    r"""DocumentRecord is the QCR representation of an ingested document.
    Immutable once extracted. Source-format-agnostic.
    ...
    def serialize_model(self, handler):
        optional_fields = set(["document", "id", "layout", "source_format"])
