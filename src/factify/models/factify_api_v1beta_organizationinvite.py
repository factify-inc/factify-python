...
class FactifyAPIV1betaOrganizationInviteTypedDict(TypedDict):
    ...
    status: FactifyAPIV1betaOrganizationInviteStatus
    r"""OrganizationInviteStatus represents the state of an organization invitation."""
    sender: FactifyAPIV1betaUserTypedDict
    ...
    """
    accepted_by: NotRequired[FactifyAPIV1betaUserTypedDict]
    r"""User represents a user or service account."""
...
class FactifyAPIV1betaOrganizationInvite(BaseModel):
    r"""OrganizationInvite represents an invitation to join an organization.
    accepted_fields_consistency // accepted_at and accepted_by must both be set or both be unset
    ...
    accepted_by: Optional[FactifyAPIV1betaUser] = None
    r"""User represents a user or service account."""
