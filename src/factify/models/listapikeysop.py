...
class ListAPIKeysResponseResponseTypedDict(TypedDict):
    http_meta: HTTPMetadataTypedDict
    headers: Dict[str, List[str]]
    list_api_keys_response: NotRequired[ListAPIKeysResponseTypedDict]
    r"""Success"""


class ListAPIKeysResponseResponse(BaseModel):
    next: Union[
        Callable[[], Optional[ListAPIKeysResponseResponse]],
        Callable[[], Awaitable[Optional[ListAPIKeysResponseResponse]]],
    ]
    ...
    list_api_keys_response: Optional[ListAPIKeysResponse] = None
    r"""Success"""

    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["ListApiKeysResponse"])
        serialized = handler(self)
        m = {}
